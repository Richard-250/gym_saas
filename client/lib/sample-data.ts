...
export const generateSampleGyms = (): Gym[] => [
  {
    ...
    ownerId: 'user-1',
    settings: {
      location: { country: 'Rwanda', region: 'Kigali', addressLine: '123 Fitness St' },
  ...
  },
  {
    ...
    ownerId: 'user-1',
    settings: {
      location: { country: 'Rwanda', region: 'Kigali', addressLine: '456 Athletic Ave' },
      timezone: 'Africa/Kigali',
      currency: 'RWF',
...
export const generateSampleMembers = (gymId: string): Member[] => [
  ...
  },
  {
    ...
    profile: 'https://images.unsplash.com/photo-1494790108755-2616b612b884?w=150&h=150&fit=crop&crop=face',
